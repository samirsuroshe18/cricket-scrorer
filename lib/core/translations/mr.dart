...
Map<String, String> mr = {
  ...
  TranslationKeys.passwordTooShort: 'पासवर्ड किमान ८ वर्णांचा असावा',
  ...
  TranslationKeys.welcomeBack: 'परत स्वागत आहे',
  TranslationKeys.signInToKeepScoring: 'स्कोअरिंग सुरू ठेवण्यासाठी साइन इन करा',
  TranslationKeys.noAccountNeeded: 'खात्याची आवश्यकता नाही',
  ...
  TranslationKeys.passwordStrength: 'पासवर्डची मजबुती',
  TranslationKeys.passwordStrengthWeak: 'कमकुवत',
  TranslationKeys.passwordStrengthFair: 'ठीकठाक',
  TranslationKeys.passwordStrengthStrong: 'मजबूत',
  TranslationKeys.passwordsMatch: 'पासवर्ड जुळतात',
  TranslationKeys.validEmail: 'वैध ईमेल',
  ...
  TranslationKeys.battingStyle: 'फलंदाजी शैली',
  TranslationKeys.bowlingStyle: 'गोलंदाजी शैली',
  TranslationKeys.rightHanded: 'उजव्या हाताने',
  TranslationKeys.leftHanded: 'डाव्या हाताने',
  TranslationKeys.rightArmPace: 'उजव्या हाताची पेस',
  TranslationKeys.leftArmPace: 'डाव्या हाताची पेस',
  TranslationKeys.rightArmSpin: 'उजव्या हाताची स्पिन',
  TranslationKeys.leftArmSpin: 'डाव्या हाताची स्पिन',
  TranslationKeys.continueText: 'सुरू ठेवा',
  TranslationKeys.myProfile: 'माझी प्रोफाइल',
  TranslationKeys.saveChanges: 'बदल जतन करा',
  TranslationKeys.playingRole: 'खेळण्याची भूमिका',
  TranslationKeys.enterJerseyNumber: 'जर्सी क्रमांक प्रविष्ट करा',
  TranslationKeys.jerseyNumberInvalid: 'जर्सी क्रमांक ० ते ९९९ दरम्यान असावा',
  TranslationKeys.optionalLabel: 'पर्यायी',
  TranslationKeys.profilePreview: 'पूर्वावलोकन',
  TranslationKeys.profilePreviewHint: 'तुमची प्रोफाइल अशी दिसेल',
  TranslationKeys.optionalDetailsHint:
      'फोटो, बायो आणि खेळण्याची शैली पर्यायी आहेत — त्या नंतरही माझी प्रोफाइलमधून जोडता येतात.',
  ...
  TranslationKeys.average: 'सरासरी',
  TranslationKeys.highScore: 'सर्वोच्च धावसंख्या',
  TranslationKeys.fifties: '50 धावा',
  TranslationKeys.hundreds: '100 धावा',
  TranslationKeys.bestBowling: 'सर्वोत्तम गोलंदाजी',
  TranslationKeys.profile: 'प्रोफाइल',
  TranslationKeys.editPlayer: 'खेळाडू संपादित करा',
  TranslationKeys.role: 'भूमिका',
  TranslationKeys.jerseyNumber: 'जर्सी क्रमांक',
  TranslationKeys.playerUpdated: 'खेळाडू अद्ययावत केला',
  ...
  TranslationKeys.matchVersus: 'विरुद्ध',
  ...
  TranslationKeys.selectTeamATitle: 'संघ A निवडा',
  TranslationKeys.selectTeamBTitle: 'संघ B निवडा',
  TranslationKeys.useAsNewTeam: '"@name" नवीन संघ म्हणून वापरा',
  TranslationKeys.swapTeams: 'संघ अदलाबदल करा',
  TranslationKeys.tapToSelectTeam: 'निवडण्यासाठी टॅप करा',
  ...
  TranslationKeys.batFirst: 'आधी फलंदाजी',
  TranslationKeys.bowlFirst: 'आधी गोलंदाजी',
  ...
  TranslationKeys.standings: 'गुणतालिका',
  TranslationKeys.noStandingsYet: 'अजून गुणतालिका नाही',
  ...
  TranslationKeys.navMatches: 'सामने',
  TranslationKeys.navTeams: 'संघ',
  TranslationKeys.navProfile: 'प्रोफाइल',
  TranslationKeys.homeGreeting: 'नमस्कार, @name',
  TranslationKeys.homeGreetingNoName: 'नमस्कार',
  TranslationKeys.liveNow: 'आत्ता लाइव्ह',
  TranslationKeys.continueScoring: 'स्कोअरिंग सुरू ठेवा',
  TranslationKeys.recentMatches: 'अलीकडील सामने',
  TranslationKeys.seeAll: 'सर्व पहा',
  TranslationKeys.filterMatches: 'फिल्टर',
  TranslationKeys.filterAll: 'सर्व',
  TranslationKeys.myTeams: 'माझे संघ',
  TranslationKeys.myTeamsEmptyHint: 'तुमचे संघ इथे दिसतील.',
  TranslationKeys.loadMoreTeams: 'आणखी संघ लोड करा',
  TranslationKeys.roleOwner: 'मालक',
  TranslationKeys.roleMember: 'सदस्य',
  TranslationKeys.searchTeamsHint: 'संघ आणि संस्था शोधा',
  TranslationKeys.noTeamsSearchResults: '"@query" साठी काहीही सापडले नाही',
  TranslationKeys.createTeam: 'टीम तयार करा',
  TranslationKeys.teamBelongsTo: 'संबंधित संस्था',
  TranslationKeys.teamIndependent: 'स्वतंत्र',
  TranslationKeys.teamNameExists: '"@name" नावाची टीम तुमच्याकडे आधीच आहे',
  TranslationKeys.teamCreated: 'टीम तयार झाली',
  TranslationKeys.teamName: 'टीमचे नाव',
  TranslationKeys.teamShortName: 'संक्षिप्त नाव',
  TranslationKeys.teamNameTooLong:
      'टीमचे नाव जास्तीत जास्त 50 अक्षरांचे असू शकते',
  ...
  TranslationKeys.statMatches: 'सामने',
  TranslationKeys.statRuns: 'धावा',
  TranslationKeys.statWickets: 'बळी',
  TranslationKeys.startFirstMatch: 'तुमचा पहिला सामना सुरू करा',
  TranslationKeys.noFilteredMatches: '@status सामने नाहीत',
  TranslationKeys.editProfile: 'प्रोफाइल संपादित करा',
  TranslationKeys.viewMyStats: 'माझी आकडेवारी पहा',
  ...
  TranslationKeys.claimPlayerHint:
      'खाते जोडल्यास फलंदाजी किंवा गोलंदाजीची पाळी आल्यावर, आणि लिलावात विकले गेल्यावर तुम्हाला सूचना मिळेल.',
  TranslationKeys.claimPlayerConfirm: 'होय, हा मीच आहे',
  TranslationKeys.claimPlayerSuccess:
      'तुम्ही @name ला तुमच्या खात्याशी जोडले आहे.',
  TranslationKeys.claimPlayerGoHome: 'होमवर जा',
  TranslationKeys.invitePlayerToClaim:
      'या खेळाडूला प्रोफाइल क्लेम करण्यासाठी आमंत्रित करा',
  TranslationKeys.playerAlreadyClaimed:
      'या खेळाडूने आधीच त्यांची प्रोफाइल क्लेम केली आहे',
  TranslationKeys.shareClaimMessage:
      'क्रिकेट स्कोअररवर तुमची क्रिकेट प्रोफाइल क्लेम करा!',
  ...
  // Home dashboard
  TranslationKeys.greetingMorning: 'शुभ प्रभात',
  TranslationKeys.greetingAfternoon: 'शुभ दुपार',
  TranslationKeys.greetingEvening: 'शुभ संध्याकाळ',
  TranslationKeys.homeLoading: 'लोड होत आहे',
  TranslationKeys.homeHeroLive: 'लाइव्ह · तुम्ही स्कोअर करत आहात',
  TranslationKeys.homeHeroBreak: 'इनिंग्ज ब्रेक · तुम्ही स्कोअर करत आहात',
  TranslationKeys.homeHeroReady: 'सुरू करण्यास तयार · तुम्ही स्कोअर करत आहात',
  TranslationKeys.homeResumeScoring: 'स्कोअरिंग सुरू ठेवा',
  TranslationKeys.homeStartScoring: 'स्कोअरिंग सुरू करा',
  TranslationKeys.homeOvShort: 'षटके',
  TranslationKeys.homeOverMatch: '@n षटकांचा सामना',
  TranslationKeys.homeInningsFirst: 'पहिला डाव',
  TranslationKeys.homeInningsSecond: 'दुसरा डाव',
  TranslationKeys.homeNeedOff: '@balls चेंडूंत @runs धावा हव्या',
  TranslationKeys.homeVsTeam: '@name विरुद्ध',
  TranslationKeys.homeStartHeroTitle: 'पुढच्या सामन्यासाठी तयार?',
  TranslationKeys.homeStartHeroBody: 'एका मिनिटात संघ, षटके आणि नाणेफेक ठरवा.',
  TranslationKeys.homeStartMatchCta: 'सामना सुरू करा',
  TranslationKeys.homeFirstHeroTitle: 'तुमचा पहिला सामना स्कोअर करा',
  TranslationKeys.homeFirstHeroBody: 'तीन पावले, कसलीही कटकट नाही.',
  TranslationKeys.homeStep1Title: 'दोन संघ निवडा',
  TranslationKeys.homeStep1Body: 'तिथल्या तिथे तयार करा',
  TranslationKeys.homeStep2Title: 'नाणेफेक करा',
  TranslationKeys.homeStep2Body: 'विजेता आणि निर्णय',
  TranslationKeys.homeStep3Title: 'चेंडू दर चेंडू स्कोअर करा',
  TranslationKeys.homeStep3Body: 'ऑफलाइनही चालते',
  TranslationKeys.homeStartFirstCta: 'पहिला सामना सुरू करा',
  TranslationKeys.homeJoinByCode: 'कोडने सहभागी व्हा',
  TranslationKeys.homeWatchWithCode: 'कोडने पहा',
  TranslationKeys.homeLiveTag: 'लाइव्ह · @n षटके',
  TranslationKeys.homeLiveTagOne: 'लाइव्ह · 1 षटक',
  TranslationKeys.homeYetToBat: 'फलंदाजी बाकी',
  TranslationKeys.homeTarget: 'लक्ष्य @n',
  TranslationKeys.homeShareLink: 'लिंक शेअर करा',
  TranslationKeys.homeShareMessage: '@teams — कोड @code ने लाइव्ह पहा\n@link',
  TranslationKeys.homeLinkCopied: 'लिंक कॉपी केली',
  TranslationKeys.matchActions: 'सामना पर्याय',
  TranslationKeys.homeYourSeason: 'तुमचा हंगाम',
  TranslationKeys.homeRecentResults: 'अलीकडील निकाल',
  TranslationKeys.homeOfflinePrefix: 'ऑफलाइन',
  TranslationKeys.homeBallsWaitingOne: '1 चेंडू सिंक होण्याच्या प्रतीक्षेत',
  TranslationKeys.homeBallsWaitingMany:
      '@count चेंडू सिंक होण्याच्या प्रतीक्षेत',
  TranslationKeys.homeUpdatesWaiting: 'अपडेट सिंक होण्याच्या प्रतीक्षेत',
  TranslationKeys.homeStripDetails: 'तपशील',
  TranslationKeys.homeStripReview: 'तपासा',
  ...
  TranslationKeys.organizations: 'संस्था',
  TranslationKeys.organizationDetail: 'संस्था',
  TranslationKeys.createOrganization: 'संस्था तयार करा',
  TranslationKeys.organizationName: 'संस्थेचे नाव',
  TranslationKeys.organizationCreated: 'संस्था तयार झाली',
  TranslationKeys.noOrganizationsYet: 'अद्याप कोणतीही संस्था नाही',
  TranslationKeys.members: 'सदस्य',
  TranslationKeys.addMember: 'सदस्य जोडा',
  TranslationKeys.memberEmail: 'सदस्याचा ईमेल',
  TranslationKeys.memberAdded: 'सदस्य जोडला गेला',
  TranslationKeys.teams: 'टीम्स',
  TranslationKeys.addTeam: 'टीम जोडा',
  TranslationKeys.teamAdded: 'टीम जोडली गेली',
  TranslationKeys.noTeamsYet: 'अद्याप कोणतीही टीम नाही',
  TranslationKeys.add: 'जोडा',
  TranslationKeys.leaveOrganization: 'सोडा',
  TranslationKeys.leaveOrganizationConfirmTitle: 'ही संस्था सोडायची का?',
  TranslationKeys.leaveOrganizationConfirmMessage:
      'तुम्हाला परत जोडल्याशिवाय त्याच्या टीम्सचा प्रवेश मिळणार नाही.',
  TranslationKeys.removeMember: 'काढा',
  TranslationKeys.removeMemberConfirmTitle: 'हा सदस्य काढायचा का?',
  TranslationKeys.removeMemberConfirmMessage:
      'त्यांना या संस्थेच्या टीम्सचा प्रवेश मिळणार नाही.',
  TranslationKeys.deleteOrganization: 'संस्था हटवा',
  TranslationKeys.deleteOrganizationConfirmTitle: 'ही संस्था हटवायची का?',
  TranslationKeys.deleteOrganizationConfirmMessage:
      'त्याच्या टीम्स पुन्हा स्वतंत्र होतील. हे पूर्ववत करता येणार नाही.',
  TranslationKeys.create: 'तयार करा',
  TranslationKeys.updateOrganizationLogo: 'लोगो बदला',
  ...
  TranslationKeys.wicketkeeper: 'यष्टिरक्षक',
