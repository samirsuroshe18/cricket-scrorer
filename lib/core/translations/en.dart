...
Map<String, String> en = {
  ...
  TranslationKeys.onboardingPageSemanticLabel: 'Page @current of @total',
  TranslationKeys.onboardingRunRateLabel: 'Run rate',
  TranslationKeys.onboardingThisOverLabel: 'This over',
  TranslationKeys.onboardingHighestOverLabel: 'Highest over',
  TranslationKeys.onboardingPowerplayLabel: 'Powerplay',
  TranslationKeys.onboardingDeathOversLabel: 'Death overs',
  TranslationKeys.onboardingOverRange: 'Over @range',
  TranslationKeys.onboardingShareScorecard: 'Share scorecard',
  TranslationKeys.onboardingSampleResult: 'Titans won by 24 runs',
  TranslationKeys.onboardingSampleContext: 'vs Strikers · Final',
  ...
  TranslationKeys.signInToKeepScoring: 'Sign in to keep scoring',
  TranslationKeys.noAccountNeeded: 'No account needed',
  ...
  TranslationKeys.passwordStrength: 'Password strength',
  TranslationKeys.passwordStrengthWeak: 'Weak',
  TranslationKeys.passwordStrengthFair: 'Fair',
  TranslationKeys.passwordStrengthStrong: 'Strong',
  TranslationKeys.passwordsMatch: 'Passwords match',
  TranslationKeys.validEmail: 'Valid email',
  ...
  TranslationKeys.editPlayer: 'Edit player',
  TranslationKeys.role: 'Role',
  TranslationKeys.jerseyNumber: 'Jersey number',
  TranslationKeys.playerUpdated: 'Player updated',
  ...
  TranslationKeys.matchVersus: 'vs',
  ...
  TranslationKeys.oversPresetCustom: 'Custom',
  TranslationKeys.oversPresetFive: '5',
  TranslationKeys.oversPresetT20: 'T20',
  TranslationKeys.oversPresetOdi: 'ODI',
  TranslationKeys.selectTeamATitle: 'Select Team A',
  TranslationKeys.selectTeamBTitle: 'Select Team B',
  TranslationKeys.useAsNewTeam: 'Use "@name" as a new team',
  TranslationKeys.swapTeams: 'Swap teams',
  TranslationKeys.tapToSelectTeam: 'Tap to select',
  ...
  TranslationKeys.batFirst: 'Bat first',
  TranslationKeys.bowlFirst: 'Bowl first',
  ...
  TranslationKeys.standings: 'Standings',
  TranslationKeys.noStandingsYet: 'No standings yet',
  ...
  TranslationKeys.invalidBasePrice:
      'Enter a whole number between 1 and 100000000',
  ...
  TranslationKeys.liveAuction: 'Live auction',
  TranslationKeys.startAuction: 'Start auction',
  TranslationKeys.auctionNotStarted:
      'Waiting for the organizer to start the auction',
  TranslationKeys.auctionCompleted: 'Auction completed',
  TranslationKeys.nextPlayer: 'Next player',
  TranslationKeys.waitingForNextPlayer: 'Waiting for the next player',
  TranslationKeys.budgets: 'Budgets',
  TranslationKeys.bidHistory: 'Bid history',
  ...
  TranslationKeys.navHome: 'Home',
  TranslationKeys.navMatches: 'Matches',
  TranslationKeys.navTeams: 'Teams',
  TranslationKeys.navProfile: 'Profile',
  TranslationKeys.homeGreeting: 'Hi, @name',
  TranslationKeys.homeGreetingNoName: 'Hi there',
  TranslationKeys.liveNow: 'Live now',
  TranslationKeys.continueScoring: 'Continue scoring',
  TranslationKeys.recentMatches: 'Recent matches',
  TranslationKeys.seeAll: 'See all',
  TranslationKeys.filterMatches: 'Filter',
  ...
  TranslationKeys.loadMoreTeams: 'Load more teams',
  ...
  TranslationKeys.createTeam: 'Create team',
  TranslationKeys.teamBelongsTo: 'Belongs to',
  TranslationKeys.teamIndependent: 'Independent',
  TranslationKeys.teamNameExists: 'You already have a team called "@name"',
  TranslationKeys.teamCreated: 'Team created',
  TranslationKeys.teamName: 'Team name',
  TranslationKeys.teamShortName: 'Short name',
  ...
  TranslationKeys.deleteTeam: 'Delete team',
  TranslationKeys.deleteTeamConfirmTitle: 'Delete this team?',
  TranslationKeys.deleteTeamConfirmMessage:
      'Its past matches will still show its name. This can\'t be undone.',
  TranslationKeys.teamDeleted: 'Team deleted',
  ...
  // Home dashboard
  TranslationKeys.greetingMorning: 'Good morning',
  TranslationKeys.greetingAfternoon: 'Good afternoon',
  TranslationKeys.greetingEvening: 'Good evening',
  TranslationKeys.homeLoading: 'Loading',
  TranslationKeys.homeHeroLive: 'Live · you\'re scoring',
  TranslationKeys.homeHeroBreak: 'Innings break · you\'re scoring',
  TranslationKeys.homeHeroReady: 'Ready to start · you\'re scoring',
  TranslationKeys.homeResumeScoring: 'Resume scoring',
  TranslationKeys.homeStartScoring: 'Start scoring',
  TranslationKeys.homeOvShort: 'ov',
  TranslationKeys.homeOverMatch: '@n over match',
  TranslationKeys.homeInningsFirst: '1st innings',
  TranslationKeys.homeInningsSecond: '2nd innings',
  TranslationKeys.homeNeedOff: 'Need @runs off @balls',
  TranslationKeys.homeVsTeam: 'vs @name',
  TranslationKeys.homeStartHeroTitle: 'Ready for the next one?',
  TranslationKeys.homeStartHeroBody:
      'Pick teams, set overs and toss in under a minute.',
  TranslationKeys.homeStartMatchCta: 'Start match',
  TranslationKeys.homeFirstHeroTitle: 'Score your first match',
  TranslationKeys.homeFirstHeroBody: 'Three steps, no setup headaches.',
  TranslationKeys.homeStep1Title: 'Pick two teams',
  TranslationKeys.homeStep1Body: 'Create them on the spot',
  TranslationKeys.homeStep2Title: 'Do the toss',
  TranslationKeys.homeStep2Body: 'Winner and decision',
  TranslationKeys.homeStep3Title: 'Score ball by ball',
  TranslationKeys.homeStep3Body: 'Works offline too',
  TranslationKeys.homeStartFirstCta: 'Start first match',
  TranslationKeys.homeJoinByCode: 'Join by code',
  TranslationKeys.homeWatchWithCode: 'Watch with a code',
  TranslationKeys.homeLiveTag: 'Live · @n overs',
  TranslationKeys.homeLiveTagOne: 'Live · 1 over',
  TranslationKeys.homeYetToBat: 'Yet to bat',
  TranslationKeys.homeTarget: 'Target @n',
  TranslationKeys.homeShareLink: 'Share link',
  TranslationKeys.homeShareMessage:
      '@teams — watch live with code @code\n@link',
  TranslationKeys.homeLinkCopied: 'Link copied',
  TranslationKeys.matchActions: 'Match actions',
  TranslationKeys.homeYourSeason: 'Your season',
  TranslationKeys.homeRecentResults: 'Recent results',
  TranslationKeys.homeOfflinePrefix: 'Offline',
  TranslationKeys.homeBallsWaitingOne: '1 ball waiting to sync',
  TranslationKeys.homeBallsWaitingMany: '@count balls waiting to sync',
  TranslationKeys.homeUpdatesWaiting: 'Updates waiting to sync',
  TranslationKeys.homeStripDetails: 'Details',
  TranslationKeys.homeStripReview: 'Review',
  ...
  TranslationKeys.organizations: 'Organizations',
  TranslationKeys.organizationDetail: 'Organization',
  TranslationKeys.createOrganization: 'Create organization',
  TranslationKeys.organizationName: 'Organization name',
  TranslationKeys.organizationCreated: 'Organization created',
  TranslationKeys.noOrganizationsYet: 'No organizations yet',
  TranslationKeys.members: 'Members',
  TranslationKeys.addMember: 'Add member',
  TranslationKeys.memberEmail: 'Member\'s email',
  TranslationKeys.memberAdded: 'Member added',
  TranslationKeys.teams: 'Teams',
  TranslationKeys.addTeam: 'Add team',
  TranslationKeys.teamAdded: 'Team added',
  TranslationKeys.noTeamsYet: 'No teams yet',
  TranslationKeys.add: 'Add',
  TranslationKeys.leaveOrganization: 'Leave',
  TranslationKeys.leaveOrganizationConfirmTitle: 'Leave this organization?',
  TranslationKeys.leaveOrganizationConfirmMessage:
      'You\'ll lose access to its teams unless you\'re added back.',
  TranslationKeys.removeMember: 'Remove',
  TranslationKeys.removeMemberConfirmTitle: 'Remove this member?',
  TranslationKeys.removeMemberConfirmMessage:
      'They\'ll lose access to this organization\'s teams.',
  TranslationKeys.deleteOrganization: 'Delete organization',
  TranslationKeys.deleteOrganizationConfirmTitle: 'Delete this organization?',
  TranslationKeys.deleteOrganizationConfirmMessage:
      'Its teams will become standalone again. This can\'t be undone.',
  TranslationKeys.create: 'Create',
  TranslationKeys.updateOrganizationLogo: 'Update logo',
  ...
  TranslationKeys.wicketkeeper: 'Wicketkeeper',
  TranslationKeys.captainShort: 'C',
  TranslationKeys.viceCaptainShort: 'VC',
  TranslationKeys.wicketkeeperShort: 'WK',
  TranslationKeys.squadEmptyHint: 'No players yet — add them below, or skip and type names as you score',
};
